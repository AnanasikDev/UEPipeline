# Unreal Engine Building Pipeline

This is my BUas CMGT Year 1 Block D research project : automated building pipeline.
...
All of it runs locally on your machine, giving you better control but also drawing resources and time. Very lightweight, integrates with (but doesn't require) [Perforce](https://www.perforce.com/).
...
Runs Unreal Automation Tool (UAT) BuildCookRun command, which cooks assets and maps, compresses everything, builds, compiles and finally produces a final executable along with auxiliary files.
